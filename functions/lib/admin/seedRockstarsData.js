...
exports.seedRockstarsData = void 0;
...
exports.seedRockstarsData = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'Must be signed in.');
    }
    const callerDoc = await db.collection('users').doc(request.auth.uid).get();
    if (!callerDoc.exists || callerDoc.data()?.role !== 'admin') {
        throw new https_1.HttpsError('permission-denied', 'Only admins can seed data.');
    }
...
//# sourceMappingURL=seedRockstarsData.js.map