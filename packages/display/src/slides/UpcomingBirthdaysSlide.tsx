...
export function UpcomingBirthdaysSlide({ people, monthName, isActive }: Props) {
  return (
    <div className={`slide ${isActive ? 'active' : ''}`}>
      ...
      <div className="photo-side">
        ...
        <MiniCalendar people={people} monthName={monthName} type="birthday" />
      </div>
      ...
      <div className="text-side">
        ...
        <div className="slide-title">
          ...
          {monthName.toUpperCase()} BIRTHDAYS
          <span className="fw-icon" />
        </div>
          ...
          {people.map((p, i) => (
            <div key={i} className="summary-row">
              ...
              <div className="summary-info">
                ...
                <span className="summary-detail">{monthName} {p.day}</span>
              </div>
            </div>
          ))}
        </div>
